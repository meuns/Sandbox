...
RAY0_DATA_OX = [-0.9 + (i / RAY_COUNT) * 1.8 + random() * RAY_INIT_JITTER_OX - RAY_INIT_DX for i in range(RAY_COUNT)]
RAY0_DATA_OY = [-RAY_INIT_DY] * RAY_COUNT
...
INT0_Y = [WORLD_INT_Y_JITTER * random() - 0.0 for i in range(INTX_POINT_COUNT)]
